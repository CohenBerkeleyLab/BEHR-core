...
guipath = '/Users/Josh/Documents/MATLAB/BEHR/GUIs/';
addpath(guipath);
output = no2_column_map_GUI;
if isstruct(output)
[cb, NO2_GRID, LON_GRID, LAT_GRID, COUNT] = no2_column_map_2014(output.start_date, output.end_date, output.lonbdy, output.latbdy,...
