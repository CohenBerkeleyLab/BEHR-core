...
vars = {'AMFStrat','AMFTrop','BEHRAMFTrop','BEHRColumnAmountNO2Trop','BEHRScatWeights','BEHRAvgKernels',...
    ...
    'BEHRScatWeights','BEHRAvgKernels','BEHRPressureLevels','BEHRNO2apriori'};
...
attr_table = {  'AMFStrat', 'unitless', [0, Inf], nofill, 'SP', 'Stratospheric AMF';...
                ...
                'BEHRScatWeights', 'unitless', [0, Inf], behrfill, 'BEHR', 'Scattering weights used for each pixel, pressure levels given by BEHRPressureLevels. See readme for more information on calculation';...
                'BEHRAvgKernels', 'unitless', [0, Inf], behrfill, 'BEHR', 'Scattering weights divided by AMF, pressure levels given by BEHRPressureLevels';...
                'BEHRPressureLevels' 'hPa', [0, Inf], behrfill, 'BEHR', 'Pressure levels for the scattering weights and averaging kernels. Each pixel will have slightly different levels.';...
