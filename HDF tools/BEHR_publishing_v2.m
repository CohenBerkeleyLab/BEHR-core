...
vars = {'AMFStrat','AMFTrop','BEHRAMFTrop','BEHRColumnAmountNO2Trop',...
    ...
    'FoV75CornerLongitude','FoV75CornerLatitude','TiledCornerLongitude','TiledCornerLatitude',...
    'FoV75Area','TiledArea','SpacecraftLongitude','SpacecraftLatitude','SpacecraftAltitude',...
...
attr_table = {  'AMFStrat', 'unitless', [0, Inf], nofill, 'SP', 'Stratospheric AMF';...
                ...
                'FoV75CornerLatitude', 'deg', [-90 90], longfill, 'SP', 'Pixel corner latitudes defining where 75% of the radiance comes from';...
                'FoV75CornerLongitude', 'deg', [-180 180], longfill, 'SP', 'Pixel corner longitudes defining where 75% of the radiance comes from';...
