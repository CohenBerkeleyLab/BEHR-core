...
fileTmp = 'C:\Ashley\NewCaRetrieval2\tools\nmcTmpYr.txt'; %temperature correction
fileDamf='C:\Ashley\NewCaRetrieval2\tools\damf.txt'; %amf lookup table
fileNO2='C:\Ashley\NewCaRetrieval2\tools\PRFTAV.txt'; %no2 profile for SP

load us_4km %terrain pressure table for BEHR
satellite='OMI';
retrieval='SP';
region='SWUS';
...
for j=1:total_days;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                
                %get global modis albedo map for specified day (files on J:\MODIS_8day)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
                ...
                [temperature, tmpSAVE] = rNmcTmp2(fileTmp, pressure, lon, lat, mon); %temperature correction
                ...
                %dAmfClr (calc amf under clear conditions)
                ...
                %dAmfCld (calc amf under cloudy conditions)
                ...
                %Get NO2 profile from WRF or wherever
                %no2profile
