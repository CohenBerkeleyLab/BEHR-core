...
last_file=dir(fullfile('J:','New_Retrieval_sp_mats','NEUS_wcld','BEHR_new'));
...
for j=1:total_days;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                
        ...
        for d=1:s(2);
            ...
            Longitude=(-95+0.025):0.05:(-65-0.025); Longitude=repmat(Longitude,250,1);
